...
import { about, aboutStats, experience, aboutInfraImg, projects, type Accent, AboutContent, AboutStat, ExperienceEntry } from '../../data/site';
...
export class AboutComponent {
    protected readonly about: AboutContent = about;
    protected readonly aboutStats: AboutStat[] = aboutStats.map((s: AboutStat): AboutStat => s.label === 'Projects Shipped' ? { ...s, value: `${ projects.length }` } : s);
    protected readonly experience: ExperienceEntry[] = experience;
    protected readonly aboutInfraImg: string = aboutInfraImg;
