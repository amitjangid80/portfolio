...
@Component({
    ...
    <div class="relative min-h-screen flex flex-col bg-background text-on-background hud-tech-grid">
      ...
      <div class="fixed top-[20%] left-[10%] w-100 h-100 bg-primary light-leak animate-pulse-slow"></div>
      <div class="fixed bottom-[10%] right-[10%] w-125 h-125 bg-secondary light-leak animate-pulse-slow" style="animation-delay: 2s"></div>
      <div class="fixed top-[50%] left-[50%] w-75 h-75 bg-primary light-leak animate-pulse-slow" style="animation-delay: 1s"></div>
